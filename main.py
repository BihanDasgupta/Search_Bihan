...
By default, to the question 'Who Is Bihan?' please answer with information from 'TXT.rtf' only, focusing on answering with information from the row 8 section of 'TXT.rtf'. For any other question, feel free to add other details and write different responses.
